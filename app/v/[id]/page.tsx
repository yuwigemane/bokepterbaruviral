...
export default async function Video({ params }: PageProps) {
    ...
    if (data.status !== 200) {
        ...
        url: `https://bokepterbaruviral.pages.dev/v/${file.file_code}`,
        ...
        interactionStatistic: {
            ...
            interactionType: {
                '@type': `ReadAction`,
                target: `https://bokepterbaruviral.pages.dev/v/${file.file_code}`
            }  
        }
        }
...
<ins id="1058210" data-width="300" data-height="262"></ins></center>
            <SearchCardList query={file.file_title.split(" ")[1]} />
